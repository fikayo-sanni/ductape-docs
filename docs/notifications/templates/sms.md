...
## Provider Setup
SMS notifications are sent through the SMS provider configured for your environment (such as Twilio, Nexmo/Vonage, or Plivo). See [Notification Environment Setup](../setup#sms-notifications) for details on configuring your provider.
