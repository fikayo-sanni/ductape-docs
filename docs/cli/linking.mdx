...
`ductape init` also creates `.env.ductape.example`, a language example file, `ductape/README.md`, and scaffolds `ductape/database/schema.json` with `ductape/database/migrations/` for [database schema management](./database).
