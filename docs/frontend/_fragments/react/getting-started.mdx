...
```bash
npm install @ductape/react@latest @ductape/client@latest
# or
yarn add @ductape/react@latest @ductape/client@latest
# or
pnpm add @ductape/react@latest @ductape/client@latest
```
