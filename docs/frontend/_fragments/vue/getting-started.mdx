...
```bash
npm install @ductape/vue@latest @ductape/client@latest
# or
yarn add @ductape/vue@latest @ductape/client@latest
# or
pnpm add @ductape/vue@latest @ductape/client@latest
```
