...
`@ductape/nestjs` is a TypeScript/NestJS package. All code samples in this section are **TypeScript**.
:::
...
```bash
npm install @ductape/nestjs@latest @ductape/sdk@latest @nestjs/common @nestjs/core reflect-metadata rxjs
```
