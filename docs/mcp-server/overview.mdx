...
| [`ductape_features_validate_project`](./tools#ductape_features_validate_project) | Read-only AST conformance validation before Feature sync |
| [`ductape_cli`](./tools#ductape_cli) | Run authenticated administrative CLI operations |
